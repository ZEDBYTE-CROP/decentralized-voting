...
contract Election {
    ...
    function registerAsVoter(string memory _name, string memory _phone, bool _verifedStatus) public {
    ...
    function vote(uint256 candidateId) public {
        ...
        voterDetails[msg.sender].votedFor = candidateDetails[candidateId].header;
    }
